<div class="w-full">
    <div class="mb-5">
        <h1 class="text-2xl font-semibold text-gray-900">
            {{ __('Welcome to Cégem360 Kontrolling') }}
        </h1>
    ...
    <form wire:submit="register" class="space-y-4">
        ...
        <p class="text-center text-xs text-gray-500">
            ...
            {{ __('and') }}
            <a href="#" class="underline" style="color: #059669 !important;">{{ __('Privacy Policy') }}</a>.
        </p>

        <p class="text-center text-sm text-gray-500 pt-2">
            {{ __('Already have an account?') }}
            <a href="{{ route('filament.admin.auth.login') }}" class="font-medium" style="color: #059669 !important;">
                {{ __('Sign in') }}
            </a>
        </p>
    </form>
