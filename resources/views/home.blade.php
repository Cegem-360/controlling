    ...
    <section class="bg-gradient-to-b from-emerald-50 to-white pt-24 pb-16 lg:pt-32 lg:pb-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                {{-- Badge --}}
                <div
                    class="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-sm font-medium mb-6">
                ...
                <p class="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    Gyűjtse össze a Google Analytics, Search Console és Google Ads adatait egyetlen dashboardon.
                    Állítson be KPI-okat, kapjon automatikus riportokat, és hozzon döntéseket valós számok alapján – nem
                    megérzésből.
                </p>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                    ...
                    <a href="https://cegem360.eu/kapcsolat"
                        class="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-emerald-700 bg-white border-2 border-emerald-200 rounded-full hover:bg-emerald-50 transition-colors">
                        Demó kérése
                    </a>
                </div>
            ...
            <div class="mt-16 relative">
                <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 max-w-5xl mx-auto">
                    <img src="{{ Vite::asset('resources/images/module-screenshot.webp') }}"
                        alt="Cégem360 Kontrolling Dashboard" class="rounded-xl w-full">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-gradient-to-br from-orange-50 to-white rounded-2xl p-8 border border-orange-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Három különböző felület, három különböző adat
                    </h3>
                    <p class="text-gray-600">
                        Minden reggel be kell jelentkeznie a Google Analytics-be, a Search Console-ba és a Google Ads-be
                        külön-külön. Az adatok nem állnak össze képpé, és órákba telik a havi riport elkészítése.
                    </p>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100">
                    ...
                    <p class="text-gray-600">
                        Mire kiderül, hogy a forgalom visszaesett vagy a hirdetési költségek elszálltak, már napok
                        teltek el. A reaktív helyett proaktívnak kellene lennie.
                    </p>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-green-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">A vezetőség számokat kér, Ön táblázatokkal küzd
                    </h3>
                    <p class="text-gray-600">
                        Excel-táblákba másolja az adatokat, formázza, számol – és közben tudja, hogy a következő
                        hónapban ugyanezt kell csinálnia. Automatizálás helyett adminisztráció.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-emerald-50 rounded-2xl p-8 lg:p-12 border border-emerald-100 text-center max-w-4xl mx-auto">
                ...
                <p class="text-lg text-gray-600">
                    Egyetlen felületen látja a weboldalához kapcsolódó összes marketing adatot. Beállítja a KPI-okat
                    egyszer, és a rendszer figyeli helyette. Ha valami eltér a tervtől, azonnal értesítést kap.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Google Analytics, Search Console és Google Ads adatok egyetlen képernyőn. Látja a látogatókat, a
                        kulcsszavakat, a hirdetési költségeket és a konverziókat.
                    </p>
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Határozza meg a fontos mutatókat, és a rendszer automatikusan figyeli azokat. Azonnal látja, hol
                        tart a cél eléréséhez képest.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Felejtse el a havi riport-készítést. Állítsa be egyszer, és a rendszer automatikusan elküldi a
                        jelentést e-mailben.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Ha a forgalom hirtelen visszaesik vagy egy KPI veszélybe kerül, azonnal értesítést kap. A
                        rendszer figyel Ön helyett.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Hasonlítsa össze az aktuális teljesítményt a múlt hónappal vagy az előző évvel. Értse meg a
                        trendeket.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                ...
                <div
                    ...
                    <p class="text-gray-600 mb-4">
                        Ossza meg a dashboardot a csapattal vagy a vezetőséggel. Különböző jogosultsági szintekkel
    ...
    <section id="integraciok" class="py-16 lg:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Egyetlen kattintással összekapcsolja Google fiókját, és az adatok automatikusan frissülnek minden
                    nap.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-orange-50 to-white rounded-2xl p-8 border border-orange-100">
                    ...
                    <p class="text-gray-600 mb-4">
                        Látogatók, munkamenetek, oldalmegtekintések, bounce rate, átlagos munkamenet időtartam, forgalmi
                        források, eszközök, demográfia.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-blue-100">
                    ...
                    <p class="text-gray-600 mb-4">
                        Organikus megjelenések, kattintások, CTR, átlagos pozíció, indexelési státusz, kulcsszavak,
                ...
                <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-green-100">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm">
                            <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none">
                                <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="#34A853" stroke-width="2"
                                    stroke-linejoin="round" />
                                <path d="M2 17L12 22L22 17" stroke="#34A853" stroke-width="2"
                                    stroke-linejoin="round" />
                                <path d="M2 12L12 17L22 12" stroke="#34A853" stroke-width="2"
                                    stroke-linejoin="round" />
                            </svg>
                        </div>
                    ...
                    <p class="text-gray-600 mb-4">
                        Hirdetési költség, megjelenések, kattintások, CPC, konverziók, ROAS, kampány és hirdetéscsoport
                        szintű adatok.
                    </p>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-center gap-2">
    ...
    <section class="py-16 lg:py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Ne vesszen el az adattengerben. Határozza meg a kulcsfontosságú mutatókat, és csak arra fókuszáljon,
                    ami a növekedést hajtja.
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 max-w-4xl mx-auto">
                ...
                <p class="text-gray-600 text-center mb-6">
                    Válasszon előre elkészített sablonokból, vagy hozzon létre sajátot. A jelentések automatikusan
                    frissülnek az aktuális adatokkal.
                </p>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    A modul alapja a webes forgalomelemzés, de igény szerint bővíthető pénzügyi, értékesítési vagy
                    bármely más üzleti terület adataival.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-200">
                    ...
                    <p class="text-gray-600 mb-4">
                        Kapcsolja össze a marketing költségeket a tényleges üzleti eredményekkel. Importáljon pénzügyi
                        adatokat, és lássa a teljes képet.
                    </p>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-200">
                    ...
                    <p class="text-gray-600 mb-4">
                        Kövesse az utat a webes látogatótól a lezárt üzletig. Értse meg, melyik csatorna hozza a legtöbb
                        és legjobb minőségű leadet.
                    </p>
                    <span class="inline-block text-sm text-gray-500 italic">Egyedi fejlesztés projekt keretében</span>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 border border-gray-200">
                    ...
                    <p class="text-gray-600 mb-4">
                        API-n keresztül bármilyen rendszerből importálhat adatokat. ERP, CRM, számlázó, webshop – minden
                        egy helyen.
                    </p>
                    <span class="inline-block text-sm text-gray-500 italic">Egyedi fejlesztés projekt keretében</span>
                </div>
            ...
            <div class="text-center mt-8">
                <a href="#"
                    class="inline-flex items-center gap-2 text-emerald-600 font-medium hover:text-emerald-700 transition-colors">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-gray-50 rounded-2xl p-8">
                    ...
                    <p class="text-gray-700 mb-6 italic">
                        "Korábban 2-3 órát töltöttem minden hónap elején a riport készítésével. Most 5 perc alatt
                        megvan, és még pontosabb is."
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600 font-semibold">
                            KP
                        </div>
                        <div>
                    ...
                    <div class="mt-4">
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-medium rounded-full">
                ...
                <div class="bg-gray-50 rounded-2xl p-8">
                    ...
                    <p class="text-gray-700 mb-6 italic">
                        "Végre egy helyen látom a GA és a Google Ads adatokat. Azonnal látom, ha valami nem stimmel, és
                        reagálhatok."
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                    ...
                    <div class="mt-4">
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-medium rounded-full">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                            </svg>
                ...
                <div class="bg-gray-50 rounded-2xl p-8">
                    ...
                    <p class="text-gray-700 mb-6 italic">
                        "A vezetőségnek már nem kell magyaráznom a számokat – elküldöm a riportot, és minden világos.
                        Professzionálisabb lettem a szemükben."
                    </p>
                    <div class="flex items-center gap-3">
                        <div
                    ...
                    <div class="mt-4">
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 bg-purple-100 text-purple-700 text-xs font-medium rounded-full">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a href="https://cegem360.eu/admin/register"
                    class="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-semibold text-emerald-600 bg-white rounded-full hover:bg-emerald-50 transition-colors shadow-lg">
                    próba indítása
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M14 5l7 7m0 0l-7 7m7-7H3" />
            ...
            <div class="space-y-4" x-data="{ openFaq: null }">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 1" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Egyszerű: bejelentkezik Google fiókjával, engedélyezi az Analytics, Search Console és/vagy
                            Ads hozzáférést, és pár percen belül látja az első adatokat. Nincs szükség technikai
                            tudásra.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 2" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Csak azokhoz a Google Analytics, Search Console és Google Ads fiókokhoz, amelyekhez Ön
                            hozzáférést ad. A hozzáférés bármikor visszavonható a Google biztonsági beállításaiban.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 3" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Igen. A rendszer GDPR-kompatibilis, az adatok titkosított kapcsolaton keresztül közlekednek,
                            és kizárólag az Ön fiókjában érhetők el. Nem osztjuk meg harmadik féllel.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 4" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            A Starter csomagban 1, a Professional-ban 5 weboldal szerepel. Extra weboldalak +4.900 Ft/hó
                            áron adhatók hozzá. Enterprise csomagnál korlátlan.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 5" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            A 14 napos próbaidőszak után választhat: előfizet valamelyik csomagra, vagy a fiók inaktívvá
                            válik. Az adatait 30 napig megőrizzük, utána töröljük.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 6" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Igen, bármilyen egyedi KPI-t definiálhat a rendelkezésre álló adatokból. Ha olyan mutatóra
                            van szüksége, ami egyedi adatforrást igényel, azt projekt keretében fejlesztjük le.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 7" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Beállítja, milyen adatokat szeretne a riportban, milyen gyakran (heti/havi), és megadja a
                            címzettek e-mail címét. A rendszer automatikusan elküldi a jelentést a megadott időpontban.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="openFaq === 8" x-collapse>
                        <div class="px-6 pb-4 text-gray-600">
                            Igen, a Facebook Ads, LinkedIn Ads és Bing Ads integrációk fejlesztés alatt állnak. Ha van
                            konkrét igénye, jelezze nekünk.
                        </div>
                    </div>
                </div>
            </div>
