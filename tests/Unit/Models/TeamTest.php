...
it('has many search pages', function () {
    $team = Team::factory()->create();
...
it('has many search queries', function () {
    $team = Team::factory()->create();
...
it('has many analytics pageviews', function () {
    $team = Team::factory()->create();
...
it('has many analytics sessions', function () {
    $team = Team::factory()->create();
...
it('has many analytics events', function () {
    $team = Team::factory()->create();
...
it('has many analytics conversions', function () {
    $team = Team::factory()->create();
