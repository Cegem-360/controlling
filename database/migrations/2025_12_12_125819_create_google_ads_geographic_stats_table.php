...
return new class() extends Migration
{
    ...
    {
        Schema::create('google_ads_geographic_stats', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('team_id')->constrained()->cascadeOnDelete();
            $table->date('date')->index();
            $table->string('geo_target_constant')->comment('Google Ads geo target ID');
    ...
    {
        Schema::dropIfExists('google_ads_geographic_stats');
    }
};
