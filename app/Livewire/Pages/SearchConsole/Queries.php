...
final class Queries extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->dateRangeType = Session::get('search_console_queries_date_range', '28_days');
    ...
    public function setDateRange(string $type): void
    {
        ...
        session(['search_console_queries_date_range' => $type]);
        $this->loadQueriesData();
    }
    ...
    {
        $filtered = $this->filterData($this->queries, $this->search, ['query', 'country', 'device']);
